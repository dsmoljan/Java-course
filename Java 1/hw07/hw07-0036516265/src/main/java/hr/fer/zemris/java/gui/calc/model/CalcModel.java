...
public interface CalcModel {
	...
	/**
	 * Postavlja vrijednost zastavice frozenValue na true, odnosno obviještava model da je pritisnuta tipka
	 * neke operacije i da ne treba resetirati prikaz
	 * @param value
	 */
	void freezeValue(String value);
	
	/**
	 * Provjerava ima li model zamrznutu vrijednost
	 * @return
	 */
