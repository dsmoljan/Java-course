...
public class Prob1Test {
	...
	public void testNoActualContent() {
		...
		assertEquals(TokenType.EOF, lexer.nextToken().getType(), "Input had no content. Lexer should have generated only EOF token.");
	}
	...
	//dopiši još poojedinačne testove za svih 9 testnih primjera iz test/resources koji koriste ovu metodu, zasad ništa još ne koristi ovu metodu
